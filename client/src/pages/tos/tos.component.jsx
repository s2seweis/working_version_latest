...
import { Segment, Image, OptionLink} from './tos.styles'



const ImageExampleFloated = () => (
  <Segment>
  <Header as='h2' image='/school.png' content='TOS = Terms of Service'/>
    <p>
    ...
    <Image src={'/image-text.png'} size='small' floated='right' />
    <p>
    ...
    <Image src={'/image-text.png'} size='small' floated='left' />
    <p>
      Te eum doming eirmod, nominati pertinacia argumentum ad his. Ex eam alia
      facete scriptorem, est autem aliquip detraxit at. Usu ocurreret
      referrentur at, cu epicurei appellantur vix. Cum ea laoreet recteque
